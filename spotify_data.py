...
feature_csv = open('feature_rating.csv', 'w', encoding = 'utf8')
feature_csv.write("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n"%("Artist","Album","Score", csv_col[0], csv_col[1], csv_col[2], csv_col[3], csv_col[4], csv_col[5], csv_col[6]))
